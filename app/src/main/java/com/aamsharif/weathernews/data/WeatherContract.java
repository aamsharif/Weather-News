...
public final class WeatherContract {
     ...
     * Play Store.
     */
    public static final String CONTENT_AUTHORITY = "com.aamsharif.weathernews";

    // The base of all URI's which apps will use to contact the content provider for Weather News
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    /*
     * Possible paths that can be appended to BASE_CONTENT_URI to form valid URI's that
     * Weather News can handle. For instance,
     *
    ...
    public static final class WeatherEntry implements BaseColumns {
         ...
         * in compound selection, we used today's date as an argument in the query.
         *
         * @return The selection part of the weather query for today onwards
         */
        public static String getSqlSelectForTodayOnwards() {
            long normalizedUtcNow = WeatherNewsDateUtils.normalizeDate(System.currentTimeMillis());
