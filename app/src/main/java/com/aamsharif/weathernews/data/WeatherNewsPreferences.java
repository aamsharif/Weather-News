...
public final class WeatherNewsPreferences {
     ...
     * will return is "Dhaka, BD", which is Dhaka, Bangladesh.
     *
     * @param context Context used to access SharedPreferences
     * @return Location The current user has set in SharedPreferences. Will default to
     * "Dhaka, BD" if SharedPreferences have not been implemented yet.
     */
    ...
    /**
     * Returns true if the user prefers to see notifications from Weather News, false otherwise. This
    ...
    public static boolean areNotificationsEnabled(Context context) {
        ...
        /*
         * In Weather News, the user has the ability to say whether she would like notifications
    ...
    public static long getLastNotificationTimeInMillis(Context context) {
        // Key for accessing the time at which Weather News last displayed a notification
