...
public class DetailActivity extends AppCompatActivity implements
    ...
    private static final String FORECAST_SHARE_HASHTAG = " #WeatherNewsApp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * Register DetailActivity as an OnPreferenceChangedListener to receive a callback when a
    ...
    protected void onStart() {
        ...
        if (PREFERENCES_HAVE_BEEN_UPDATED) {
            ...
            WeatherEntry weatherEntry = mViewModel.getWeather().getValue();
            if(weatherEntry != null) bindWeatherToUI(weatherEntry);
    ...
    private void bindWeatherToUI(WeatherEntry weatherEntry) {
         ...
         * WeatherNewsDateUtils.getFriendlyDateString() takes care of this for us.
         */
        long localDateMidnightGmt = weatherEntry.getDate().getTime();
        String dateText = WeatherNewsDateUtils.getFriendlyDateString(DetailActivity.this, localDateMidnightGmt, true);
