...
public final class WeatherUtils {
     ...
     *
     * @param temperatureInCelsius Temperature in degrees Celsius
     *
     ...
     * this method will perform temperature conversion if necessary. It will also format the
     * temperature so that no decimal points show.
     *
     * @param context     Android Context to access preferences and resources
     * @param temperature Temperature in degrees Celsius
     *
     * @return Formatted temperature String in the form "21°"
     */
