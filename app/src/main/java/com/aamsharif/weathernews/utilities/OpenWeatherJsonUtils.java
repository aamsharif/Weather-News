...
public final class OpenWeatherJsonUtils {
     ...
     *
     * @return Array of ContentValues describing weather data
     *
    ...
    public static ContentValues[] getWeatherContentValuesFromJson(Context context, String forecastJsonStr)
        ...
        /*
         * Open Weather Map returns daily forecasts based on the local time of the city that is
         * being asked for, which means that we need to know the GMT offset to translate this data
         * properly. Since this data is also sent in-order and the first day is always the current
        ...
        for (int i = 0; i < jsonWeatherArray.length(); i++) {
             ...
             */
            dateTimeMillis = normalizedUtcStartDay + WeatherNewsDateUtils.DAY_IN_MILLIS * i;
            ...
            /*
             * Description is in a child array called "weather", which has only 1 element.
